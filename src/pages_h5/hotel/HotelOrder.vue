            ...
            <div class="card-group row">
              ...
              >
                <div class="card-body py-0 px-1">
                  ...
                  <p class="card-text">
                    {{rp.inclusiveAmount}}
                    <span>{{getMealTypeDesc(rp.mealType)}}{{rp.mealCount}}份</span>
                  </p>
                </div>
              </div>
            </div>
        ...
        <div class="tab-content" id="myTabContent">
          ...
          >
            <div class="card">
              <dl class="row">
                ...
                <dd class="col-8">{{getPayTypeDesc(detail.payType)}}/{{detail.payRemark}}</dd>
                ...
                <dd class="col-8">{{detail.approvalStatus}}, {{detail.approvalDenyReason}}</dd>
                <dt class="col-4 text-right">合规性校验</dt>
                <dd class="col-8">{{detail.violationStatus}}, {{detail.violationReason}}</dd>
              </dl>
            </div>
          </div>
        </div>
          <div class="card-body">
            <div class="d-flex flex-row justify-content-around">
              <template
                v-if="detail.status === 0 || detail.status === 10 || detail.status === 20 || detail.status === 1"
              >
