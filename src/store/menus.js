export const menus = [
  {
    ...
    submenus: [
      ...
      { to: '', caption: '' },
      { to: '/rental/car', caption: '租车', authorized: 0, 'h5_mode': 0 },
      { to: '/rental/car/orders', caption: '租车订单', authorized: 0, 'h5_mode': 0 },
      { to: '', caption: '' },
      { to: '/attractions', caption: '景点', authorized: 0, 'h5_mode': 0 },
