    ...
    <div class="card">
      ...
      <div class="card-body py-1 px-1">
        <form  class="form-inline">
          ...
          <router-link class="btn btn-primary ms-auto" to="/flt/search">国内航班</router-link>
          <router-link class="btn btn-primary ms-auto" to="/intlFlight/search">国际航班</router-link>
          <router-link class="btn btn-success ms-auto" to="/flt/order">新建手工订单</router-link>
        </form>
      </div>
    </div>
