              ...
              <tbody>
                <tr>
                  <td class="text-center">
                    <input type="text" class="form-control form-control-sm"v-model.number="parvalue" />
                  </td>
                  <td class="text-center">
                    <input type="text" class="form-control form-control-sm" v-model.number="tax" />
                  </td>
                  <td class="text-center">
                    <input type="text" class="form-control form-control-sm" v-model.number="cost" />
                  </td>
                  <td class="text-center">
                    <input type="text" class="form-control form-control-sm" v-model.amount="amount" />
                  </td>
                </tr>
              </tbody>
            </table>
